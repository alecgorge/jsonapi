...
/**
 * The <em>RTKInterface</em> handles all of the UDP API calls to the
 * RemoteToolkit Minecraft wrapper.
 * 
...
public class RTKInterface {
	...
	public enum CommandType {
		...
		/**
		 * Disables wrapper restarts <b>WARNING: As of now this does not stop
		 * scheduled events, only the restart-on-stop event.</b>
		 */
		DISABLE_RESTARTS,
		...
		/**
		 * Reschedule the next restart. NOTE: The rescheduled restart time
		 * String is a required parameter and must be supplied when calling
	 ...
	 * 
	 * @param port
	 *            The port to send API events to.
	 * @param host
	 *            The host name to send API events to.
	 * @param user
	 *            The wrapper username to send API calls as.
	 * @param password
	 *            The wrapper password that is tied to username.
	 * @param salt
	 *            the String to salt the password with.
	 */
	 ...
	 * <p>
	 * If no response has been received from the server since the current
	 * request was made, this method will block until either a response is
	 * recorded, or the request times out.
	 * 
	 * @throws InterruptedException
	 *             if the underlying wait() call is interrupted.
	 */
	 ...
	 * 
	 * @param type
	 *            The type of wrapper function to perform.
	 * @param commandParameter
	 *            used to specify extra parameters used by some CommandTypes.
	 * @throws IOException
	 *             If an IOException occurs when making the request.
	 * @throws RTKInterfaceException
