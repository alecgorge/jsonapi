...
public class JSONResponse {
	 ...
	 * Error codes:
	 * 
	 * 1 Page not found 2 Invalid JSON submitted in request 3 Server offline 4
	 * API Error 5 InvocationTargetException 6 Other caught exception 7 Method
	 * does not exist 8 The API key is wrong 9 Not allowed, but correct API key
