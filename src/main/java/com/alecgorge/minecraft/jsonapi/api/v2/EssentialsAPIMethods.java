...
public class EssentialsAPIMethods implements JSONAPIMethodProvider {
	...
	@API_Method(name = "essentials.config.get_keys", argumentDescriptions = { "void" }, returnDescription = "list of keys")
	public Set<String> get_configuration() {
		FileConfiguration x = ess.getConfig();
		return x.getKeys(true);
	}

	@API_Method(name = "essentials.config.get_text", argumentDescriptions = { "void" }, returnDescription = "whole configuration file")
